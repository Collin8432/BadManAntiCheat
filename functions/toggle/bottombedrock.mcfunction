...
execute @s[tag=§k§9♀,scores={BB=1}] ~~~ tellraw @a {"rawtext":[{"text":"§4badman §r §3→ "},{"selector":"@s"},{"text":"§5 Has Toggled BottomBedrock ON"}]}
...
execute @s[tag=§k§9♀,scores={BB=2}] ~~~ tellraw @a {"rawtext":[{"text":"§4badman §r §3→ "},{"selector":"@s"},{"text":"§5 Has Toggled BottomBedrock OFF"}]}
execute @s[tag=§k§9♀,scores={BB=2}] ~~~ scoreboard players set bbtoggledummy BB 0

#DenyNonAdmin
execute @s[tag=!§k§9♀] ~~~ tellraw @a[tag=§k§9♀] {"rawtext":[{"text":"§4badman §r §3→ "},{"selector":"@s"},{"text":"§5 Has Tried To Toggle A Admin Function - BottomBedrockToggle"}]}
execute @s[tag=!§k§9♀] ~~~ tellraw @s{"rawtext":[{"text":"§4badman §r §3→ "},{"selector":"@s"},{"text":"§5 This Is An Admin Only Function"}]}