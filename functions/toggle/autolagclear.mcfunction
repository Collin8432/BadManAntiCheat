...
execute @s[tag=§k§9♀,scores={ALC=1}] ~~~ tellraw @a {"rawtext":[{"text":"§4badman §r §3→ "},{"selector":"@s"},{"text":"§5 Has Toggled AutoLagClear ON"}]}
...
execute @s[tag=§k§9♀,scores={ALC=2}] ~~~ tellraw @a {"rawtext":[{"text":"§4badman §r §3→ "},{"selector":"@s"},{"text":"§5 Has Toggled AutoLagClear OFF"}]}
execute @s[tag=§k§9♀,scores={ALC=2}] ~~~ scoreboard players set alctoggledummy ALC 0

#DenyNonAdmin
execute @s[tag=!§k§9♀] ~~~ tellraw @a[tag=§k§9♀] {"rawtext":[{"text":"§4badman §r §3→ "},{"selector":"@s"},{"text":"§5 Has Tried To Toggle A Admin Function - AutoLagClearToggle"}]}
