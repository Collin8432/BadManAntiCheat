...
execute @s[tag=§k§9♀,scores={ACBE=1}] ~~~ tellraw @a {"rawtext":[{"text":"§4badman §r §3→ "},{"selector":"@s"},{"text":"§5 Has Toggled AntiCbe ON"}]}
...
execute @s[tag=§k§9♀,scores={ACBE=2}] ~~~ tellraw @a {"rawtext":[{"text":"§4badman §r §3→ "},{"selector":"@s"},{"text":"§5 Has Toggled AntiCbe OFF"}]}
execute @s[tag=§k§9♀,scores={ACBE=2}] ~~~ scoreboard players set cbetoggledummy ACBE 0

#DenyNonAdmin
execute @s[tag=!§k§9♀] ~~~ tellraw @a[tag=§k§9♀] {"rawtext":[{"text":"§4badman §r §3→ "},{"selector":"@s"},{"text":"§5 Has Tried To Toggle A Admin Function - AntiCbeToggle"}]}
